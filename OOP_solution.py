...
--Encapsulation was not demonstrated. 
--Inheritance is shown by both SebulbasPod and AnakinsPod receiving the class characteristics of podracer

Would it have been easier to implement a solution to this problem using a different coding style? Why or why not?
--No, because without using OOP, entire lines of code (definitions and parameters) would have to be repeated instead of simply referenced

How in particular did Object Oriented Programming assist in the solving of this problem?
--OOP assisted by defining the characteristics only once and through inheritance they could be called up and referenced without restating the variables 
'''
